...
public class AlfaCombinationAlgorithmRefImpl extends ASTWrapperPsiElement implements AlfaCombinationAlgorithmRef {

  public AlfaCombinationAlgorithmRefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitCombinationAlgorithmRef(this);
  }
