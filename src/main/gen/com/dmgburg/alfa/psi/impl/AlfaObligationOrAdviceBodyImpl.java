...
public class AlfaObligationOrAdviceBodyImpl extends ASTWrapperPsiElement implements AlfaObligationOrAdviceBody {

  public AlfaObligationOrAdviceBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitObligationOrAdviceBody(this);
  }
