...
public class AlfaAdviceBodyImpl extends ASTWrapperPsiElement implements AlfaAdviceBody {

  public AlfaAdviceBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitAdviceBody(this);
  }
