...
public class AlfaFunctionRefNameImpl extends ASTWrapperPsiElement implements AlfaFunctionRefName {

  public AlfaFunctionRefNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitFunctionRefName(this);
  }
