...
public class AlfaPolicyCombinatorDeclarationImpl extends ASTWrapperPsiElement implements AlfaPolicyCombinatorDeclaration {

  public AlfaPolicyCombinatorDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitPolicyCombinatorDeclaration(this);
  }
