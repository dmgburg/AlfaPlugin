...
public class AlfaRuleCombinatorDeclarationImpl extends ASTWrapperPsiElement implements AlfaRuleCombinatorDeclaration {

  public AlfaRuleCombinatorDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitRuleCombinatorDeclaration(this);
  }
