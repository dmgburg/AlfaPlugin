...
public class AlfaOperatorDeclarationBodyImpl extends ASTWrapperPsiElement implements AlfaOperatorDeclarationBody {

  public AlfaOperatorDeclarationBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitOperatorDeclarationBody(this);
  }
