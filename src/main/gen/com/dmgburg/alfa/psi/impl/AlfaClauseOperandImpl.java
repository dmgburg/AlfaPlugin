...
public class AlfaClauseOperandImpl extends ASTWrapperPsiElement implements AlfaClauseOperand {

  public AlfaClauseOperandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitClauseOperand(this);
  }
