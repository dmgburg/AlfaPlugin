...
public class AlfaAttributeCategoryImpl extends ASTWrapperPsiElement implements AlfaAttributeCategory {

  public AlfaAttributeCategoryImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitAttributeCategory(this);
  }
