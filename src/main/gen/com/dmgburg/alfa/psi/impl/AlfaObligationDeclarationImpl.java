...
public class AlfaObligationDeclarationImpl extends ASTWrapperPsiElement implements AlfaObligationDeclaration {

  public AlfaObligationDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitObligationDeclaration(this);
  }
