...
public class AlfaAdviceDeclarationImpl extends ASTWrapperPsiElement implements AlfaAdviceDeclaration {

  public AlfaAdviceDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitAdviceDeclaration(this);
  }
