...
public class AlfaRightClauseOperandImpl extends ASTWrapperPsiElement implements AlfaRightClauseOperand {

  public AlfaRightClauseOperandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitRightClauseOperand(this);
  }
