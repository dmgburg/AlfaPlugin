...
public class AlfaFunctionBodyReturnImpl extends ASTWrapperPsiElement implements AlfaFunctionBodyReturn {

  public AlfaFunctionBodyReturnImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitFunctionBodyReturn(this);
  }
