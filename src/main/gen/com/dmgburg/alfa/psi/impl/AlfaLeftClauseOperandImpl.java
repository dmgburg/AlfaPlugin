...
public class AlfaLeftClauseOperandImpl extends ASTWrapperPsiElement implements AlfaLeftClauseOperand {

  public AlfaLeftClauseOperandImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitLeftClauseOperand(this);
  }
