...
public class AlfaPolicySetNameImpl extends ASTWrapperPsiElement implements AlfaPolicySetName {

  public AlfaPolicySetNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitPolicySetName(this);
  }
