...
public class AlfaXacmlDeclarationImpl extends ASTWrapperPsiElement implements AlfaXacmlDeclaration {

  public AlfaXacmlDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitXacmlDeclaration(this);
  }
