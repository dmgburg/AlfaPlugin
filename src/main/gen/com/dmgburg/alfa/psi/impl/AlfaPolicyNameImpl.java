...
public class AlfaPolicyNameImpl extends ASTWrapperPsiElement implements AlfaPolicyName {

  public AlfaPolicyNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitPolicyName(this);
  }
