...
public class AlfaClauseOperatorImpl extends ASTWrapperPsiElement implements AlfaClauseOperator {

  public AlfaClauseOperatorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitClauseOperator(this);
  }
