...
public class AlfaConditionEntryImpl extends ASTWrapperPsiElement implements AlfaConditionEntry {

  public AlfaConditionEntryImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitConditionEntry(this);
  }
