...
public class AlfaObligationRefImpl extends ASTWrapperPsiElement implements AlfaObligationRef {

  public AlfaObligationRefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitObligationRef(this);
  }
