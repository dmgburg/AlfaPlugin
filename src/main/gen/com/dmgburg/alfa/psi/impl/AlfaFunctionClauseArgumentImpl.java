...
public class AlfaFunctionClauseArgumentImpl extends ASTWrapperPsiElement implements AlfaFunctionClauseArgument {

  public AlfaFunctionClauseArgumentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitFunctionClauseArgument(this);
  }
