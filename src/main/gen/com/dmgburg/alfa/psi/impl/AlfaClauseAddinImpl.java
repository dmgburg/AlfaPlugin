...
public class AlfaClauseAddinImpl extends ASTWrapperPsiElement implements AlfaClauseAddin {

  public AlfaClauseAddinImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitClauseAddin(this);
  }
