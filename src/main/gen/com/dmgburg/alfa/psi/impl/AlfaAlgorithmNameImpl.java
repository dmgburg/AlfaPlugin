...
public class AlfaAlgorithmNameImpl extends ASTWrapperPsiElement implements AlfaAlgorithmName {

  public AlfaAlgorithmNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AlfaVisitor visitor) {
    visitor.visitAlgorithmName(this);
  }
